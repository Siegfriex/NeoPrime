...
import { 
  ...
  Target, Crosshair, Filter, Brain,
  ArrowRight, X
} from 'lucide-react';
import { 
  Scatter, XAxis, YAxis, CartesianGrid, Tooltip, 
  ResponsiveContainer, ReferenceArea, Cell, ReferenceDot,
  ComposedChart, Line
} from 'recharts';
...
const StudentList: React.FC = () => {
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar">
      <div className="max-w-[1600px] mx-auto p-8 pb-20 animate-in slide-in-from-bottom-4 duration-500">
