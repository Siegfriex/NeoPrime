...
const StudentAdd: React.FC = () => {
  ...
  const scrollToSection = (e: React.MouseEvent<HTMLAnchorElement>, id: string) => {
    ...
    if (element) {
      ...
      if (container) {
         const y = element.getBoundingClientRect().top + container.scrollTop - 120; // Adjust for sticky header inside container
  ...
  return (
    <div className="h-full overflow-y-auto custom-scrollbar">
      <div className="max-w-5xl mx-auto p-8 pb-20 animate-in fade-in duration-500">
        
        {/* Header */}
        <div className="sticky top-0 z-20 bg-[#F7F9FB]/95 backdrop-blur py-4 mb-6 flex justify-between items-center border-b border-gray-200/50 -mx-8 px-8">
